/**
 * @fileoverview DTO de BoaVistaAcertaCompletoPositivoPF — DirectData.
 * @module infrastructure/providers/directdata/dtos/BoaVistaAcertaCompletoPositivoPFDto
 */

import { z } from 'zod';

export const BoaVistaAcertaCompletoPositivoPFRetornoSchema = z.object({
...
export type BoaVistaAcertaCompletoPositivoPFRetornoDto = z.infer<typeof BoaVistaAcertaCompletoPositivoPFRetornoSchema>;
