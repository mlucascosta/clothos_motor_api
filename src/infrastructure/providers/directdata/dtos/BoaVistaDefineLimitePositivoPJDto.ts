/**
 * @fileoverview DTO de BoaVistaDefineLimitePositivoPJ — DirectData.
 * @module infrastructure/providers/directdata/dtos/BoaVistaDefineLimitePositivoPJDto
 */

import { z } from 'zod';

export const BoaVistaDefineLimitePositivoPJRetornoSchema = z.object({
  ...
  participacoes: z.record(z.unknown()),
