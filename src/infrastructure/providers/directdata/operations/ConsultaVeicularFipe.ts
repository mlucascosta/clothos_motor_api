...
import { ConsultaVeicularFipeRetornoSchema } from '../dtos/ConsultaVeicularFipeDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IConsultaVeicularFipe } from '../ports/IConsultaVeicularFipe.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: ConsultaVeicularFipeRetornoSchema.nullable(),
});
 ...
 * @implements {IConsultaVeicularFipe}
 */
export class ConsultaVeicularFipe implements IConsultaVeicularFipe {
