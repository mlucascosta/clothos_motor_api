...
import { SuframaCNPJRetornoSchema } from '../dtos/SuframaCNPJDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ISuframaCNPJ } from '../ports/ISuframaCNPJ.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: SuframaCNPJRetornoSchema.nullable(),
});
 ...
 *
 * @class SuframaCNPJ
 * @implements {ISuframaCNPJ}
 */
export class SuframaCNPJ implements ISuframaCNPJ {
