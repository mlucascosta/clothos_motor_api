...
import { UnitedNationsSecurityListRetornoSchema } from '../dtos/UnitedNationsSecurityListDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IUnitedNationsSecurityList } from '../ports/IUnitedNationsSecurityList.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: UnitedNationsSecurityListRetornoSchema.nullable(),
});
 ...
 * @implements {IUnitedNationsSecurityList}
 */
export class UnitedNationsSecurityList implements IUnitedNationsSecurityList {
