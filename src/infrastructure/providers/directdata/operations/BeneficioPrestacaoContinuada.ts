...
import { BeneficioPrestacaoContinuadaRetornoSchema } from '../dtos/BeneficioPrestacaoContinuadaDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IBeneficioPrestacaoContinuada } from '../ports/IBeneficioPrestacaoContinuada.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: BeneficioPrestacaoContinuadaRetornoSchema.nullable(),
});
 ...
 * @implements {IBeneficioPrestacaoContinuada}
 */
export class BeneficioPrestacaoContinuada implements IBeneficioPrestacaoContinuada {
