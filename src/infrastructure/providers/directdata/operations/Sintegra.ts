...
import { SintegraRetornoSchema } from '../dtos/SintegraDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ISintegra } from '../ports/ISintegra.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: SintegraRetornoSchema.nullable(),
});
 ...
 *
 * @class Sintegra
 * @implements {ISintegra}
 */
export class Sintegra implements ISintegra {
