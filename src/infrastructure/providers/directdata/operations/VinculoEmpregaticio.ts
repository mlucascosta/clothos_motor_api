...
import { VinculoEmpregaticioRetornoSchema } from '../dtos/VinculoEmpregaticioDto.js';
...
const ResponseSchema = z.object({
  ...
  retorno: VinculoEmpregaticioRetornoSchema.nullable(),
});
 ...
 * @implements {IVinculoEmpregaticio}
 */
