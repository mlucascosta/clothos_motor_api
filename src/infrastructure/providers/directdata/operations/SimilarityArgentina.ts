...
import { SimilarityArgentinaRetornoSchema } from '../dtos/SimilarityArgentinaDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ISimilarityArgentina } from '../ports/ISimilarityArgentina.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: SimilarityArgentinaRetornoSchema.nullable(),
});
 ...
 * @implements {ISimilarityArgentina}
 */
export class SimilarityArgentina implements ISimilarityArgentina {
