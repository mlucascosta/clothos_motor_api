...
import { SimilarityMexicoRetornoSchema } from '../dtos/SimilarityMexicoDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ISimilarityMexico } from '../ports/ISimilarityMexico.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: SimilarityMexicoRetornoSchema.nullable(),
});
 ...
 * @implements {ISimilarityMexico}
 */
export class SimilarityMexico implements ISimilarityMexico {
