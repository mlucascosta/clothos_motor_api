...
import { z } from 'zod';
import { AuxilioEmergencialRetornoSchema } from '../dtos/AuxilioEmergencialDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IAuxilioEmergencial } from '../ports/IAuxilioEmergencial.js';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: AuxilioEmergencialRetornoSchema.nullable(),
});
 ...
 * @implements {IAuxilioEmergencial}
 */
export class AuxilioEmergencial implements IAuxilioEmergencial {
