...
import { CadastroEmpresasInidoneasSuspensasRetornoSchema } from '../dtos/CadastroEmpresasInidoneasSuspensasDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ICadastroEmpresasInidoneasSuspensas } from '../ports/ICadastroEmpresasInidoneasSuspensas.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: CadastroEmpresasInidoneasSuspensasRetornoSchema.nullable(),
});
 ...
 * @implements {ICadastroEmpresasInidoneasSuspensas}
 */
export class CadastroEmpresasInidoneasSuspensas implements ICadastroEmpresasInidoneasSuspensas {
