...
import { BeneficiosSociaisRetornoSchema } from '../dtos/BeneficiosSociaisDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IBeneficiosSociais } from '../ports/IBeneficiosSociais.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: BeneficiosSociaisRetornoSchema.nullable(),
});
 ...
 * @implements {IBeneficiosSociais}
 */
export class BeneficiosSociais implements IBeneficiosSociais {
