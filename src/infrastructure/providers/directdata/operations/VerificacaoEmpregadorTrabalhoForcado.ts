...
import { VerificacaoEmpregadorTrabalhoForcadoRetornoSchema } from '../dtos/VerificacaoEmpregadorTrabalhoForcadoDto.js';
import type { IVerificacaoEmpregadorTrabalhoForcado } from '../ports/IVerificacaoEmpregadorTrabalhoForcado.js';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: VerificacaoEmpregadorTrabalhoForcadoRetornoSchema.nullable(),
});
 ...
 * @implements {IVerificacaoEmpregadorTrabalhoForcado}
 */
export class VerificacaoEmpregadorTrabalhoForcado implements IVerificacaoEmpregadorTrabalhoForcado {
