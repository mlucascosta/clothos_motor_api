...
import { UKHmTreasuryRetornoSchema } from '../dtos/UKHmTreasuryDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IUKHmTreasury } from '../ports/IUKHmTreasury.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: UKHmTreasuryRetornoSchema.nullable(),
});
 ...
 *
 * @class UKHmTreasury
 * @implements {IUKHmTreasury}
 */
export class UKHmTreasury implements IUKHmTreasury {
