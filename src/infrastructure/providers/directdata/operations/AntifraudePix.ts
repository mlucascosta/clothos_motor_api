...
import { AntifraudePixRetornoSchema } from '../dtos/AntifraudePixDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IAntifraudePix } from '../ports/IAntifraudePix.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: AntifraudePixRetornoSchema.nullable(),
});
 ...
 *
 * @class AntifraudePix
 * @implements {IAntifraudePix}
 */
export class AntifraudePix implements IAntifraudePix {
