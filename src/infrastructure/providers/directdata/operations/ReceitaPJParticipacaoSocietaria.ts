...
import { ReceitaPJParticipacaoSocietariaRetornoSchema } from '../dtos/ReceitaPJParticipacaoSocietariaDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IReceitaPJParticipacaoSocietaria } from '../ports/IReceitaPJParticipacaoSocietaria.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: ReceitaPJParticipacaoSocietariaRetornoSchema.nullable(),
});
 ...
 * @implements {IReceitaPJParticipacaoSocietaria}
 */
export class ReceitaPJParticipacaoSocietaria implements IReceitaPJParticipacaoSocietaria {
