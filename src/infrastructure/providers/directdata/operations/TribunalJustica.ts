...
import { TribunalJusticaRetornoSchema } from '../dtos/TribunalJusticaDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ITribunalJustica } from '../ports/ITribunalJustica.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: TribunalJusticaRetornoSchema.nullable(),
});
 ...
 * @implements {ITribunalJustica}
 */
export class TribunalJustica implements ITribunalJustica {
