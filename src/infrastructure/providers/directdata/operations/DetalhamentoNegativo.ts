...
import { DetalhamentoNegativoRetornoSchema } from '../dtos/DetalhamentoNegativoDto.js';
...
const ResponseSchema = z.object({
  ...
  retorno: DetalhamentoNegativoRetornoSchema.nullable(),
});
 ...
 * @implements {IDetalhamentoNegativo}
 */
