...
import { NivelSocioeconomicoRetornoSchema } from '../dtos/NivelSocioeconomicoDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { INivelSocioeconomico } from '../ports/INivelSocioeconomico.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: NivelSocioeconomicoRetornoSchema.nullable(),
});
 ...
 * @implements {INivelSocioeconomico}
 */
export class NivelSocioeconomico implements INivelSocioeconomico {
