...
import { SeguroDefesoRetornoSchema } from '../dtos/SeguroDefesoDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ISeguroDefeso } from '../ports/ISeguroDefeso.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: SeguroDefesoRetornoSchema.nullable(),
});
 ...
 *
 * @class SeguroDefeso
 * @implements {ISeguroDefeso}
 */
export class SeguroDefeso implements ISeguroDefeso {
