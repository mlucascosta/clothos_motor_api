...
import { CadastroPessoaJuridicaPlusRetornoSchema } from '../dtos/CadastroPessoaJuridicaPlusDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ICadastroPessoaJuridicaPlus } from '../ports/ICadastroPessoaJuridicaPlus.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: CadastroPessoaJuridicaPlusRetornoSchema.nullable(),
});
 ...
 * @implements {ICadastroPessoaJuridicaPlus}
 */
export class CadastroPessoaJuridicaPlus implements ICadastroPessoaJuridicaPlus {
