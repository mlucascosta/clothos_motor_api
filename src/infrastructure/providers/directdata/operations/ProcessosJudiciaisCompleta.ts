...
import { ProcessosJudiciaisCompletaRetornoSchema } from '../dtos/ProcessosJudiciaisCompletaDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IProcessosJudiciaisCompleta } from '../ports/IProcessosJudiciaisCompleta.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: ProcessosJudiciaisCompletaRetornoSchema.nullable(),
});
 ...
 * @implements {IProcessosJudiciaisCompleta}
 */
export class ProcessosJudiciaisCompleta implements IProcessosJudiciaisCompleta {
