...
import { CONFEARetornoSchema } from '../dtos/CONFEADto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ICONFEA } from '../ports/ICONFEA.js';
import { parseOrSchemaError } from '../../../../shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: CONFEARetornoSchema.nullable(),
});
 ...
 * @implements {ICONFEA}
 */
export class CONFEA implements ICONFEA {
