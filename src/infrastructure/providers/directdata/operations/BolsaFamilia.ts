...
import { BolsaFamiliaRetornoSchema } from '../dtos/BolsaFamiliaDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { IBolsaFamilia } from '../ports/IBolsaFamilia.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: BolsaFamiliaRetornoSchema.nullable(),
});
 ...
 *
 * @class BolsaFamilia
 * @implements {IBolsaFamilia}
 */
export class BolsaFamilia implements IBolsaFamilia {
