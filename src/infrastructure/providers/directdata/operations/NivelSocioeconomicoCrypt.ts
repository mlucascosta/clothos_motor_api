...
import { NivelSocioeconomicoCryptRetornoSchema } from '../dtos/NivelSocioeconomicoCryptDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { INivelSocioeconomicoCrypt } from '../ports/INivelSocioeconomicoCrypt.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: NivelSocioeconomicoCryptRetornoSchema.nullable(),
});
 ...
 * @implements {INivelSocioeconomicoCrypt}
 */
export class NivelSocioeconomicoCrypt implements INivelSocioeconomicoCrypt {
