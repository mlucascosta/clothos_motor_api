...
import { CorreiosBuscaCEPRetornoSchema } from '../dtos/CorreiosBuscaCEPDto.js';
import { DirectDataMetaDadosSchema } from '../dtos/DirectDataResponseDto.js';
import type { ICorreiosBuscaCEP } from '../ports/ICorreiosBuscaCEP.js';
import { parseOrSchemaError } from '@shared/domain/parseOrSchemaError.js';
import { z } from 'zod';

const ResponseSchema = z.object({
  metaDados: DirectDataMetaDadosSchema,
  retorno: CorreiosBuscaCEPRetornoSchema.nullable(),
});
 ...
 * @implements {ICorreiosBuscaCEP}
 */
export class CorreiosBuscaCEP implements ICorreiosBuscaCEP {
