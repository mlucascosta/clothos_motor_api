...
export const PortalTransparenciaAuxilioItemSchema = z.object({
...
export type PortalTransparenciaAuxilioResponse = z.infer<typeof PortalTransparenciaAuxilioResponseSchema>;
