...
export const PortalTransparenciaSafraItemSchema = z.object({
...
export type PortalTransparenciaSafraResponse = z.infer<typeof PortalTransparenciaSafraResponseSchema>;
