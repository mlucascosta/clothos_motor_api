...
import { RegistradoresInfoContaResponseSchema, type RegistradoresInfoContaItem } from '../dtos/RegistradoresInfoContaDto.js';
...
export class RegistradoresInfoConta implements IInfosimplesOperation<RegistradoresInfoContaItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, RegistradoresInfoContaItem>> {
