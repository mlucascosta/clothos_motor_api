...
import {
  type PrefMgBeloHorizonteIptuItem,
  PrefMgBeloHorizonteIptuResponseSchema,
} from '../dtos/PrefMgBeloHorizonteIptuDto.js';
...
export class PrefMgBeloHorizonteIptu implements IInfosimplesOperation<PrefMgBeloHorizonteIptuItem> {
  ...
  async execute(
  ...
  ): Promise<Either<SourceError, PrefMgBeloHorizonteIptuItem>> {
    ...
    return parseInfosimplesResponse(PrefMgBeloHorizonteIptuResponseSchema, result.value);
  }
}
