...
import { CarImovelResponseSchema, type CarImovelItem } from '../dtos/CarImovelDto.js';
...
export class CarImovel implements IInfosimplesOperation<CarImovelItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, CarImovelItem>> {
