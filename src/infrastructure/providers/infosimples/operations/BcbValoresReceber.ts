...
import { BcbValoresReceberResponseSchema, type BcbValoresReceberItem } from '../dtos/BcbValoresReceberDto.js';
...
export class BcbValoresReceber implements IInfosimplesOperation<BcbValoresReceberItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, BcbValoresReceberItem>> {
