/**
 * @fileoverview Operation — Registradores / Certidão Recibo
 * Endpoint: POST consultas/registradores/certid/recibo
 * @module infrastructure/providers/infosimples/operations/RegistradoresCertidRecibo
 */
  ...
  implements IInfosimplesOperation<RegistradoresCertidReciboItem>
{
  ...
  async execute(
    ...
    return parseInfosimplesResponse(RegistradoresCertidReciboResponseSchema, result.value);
  }
}
