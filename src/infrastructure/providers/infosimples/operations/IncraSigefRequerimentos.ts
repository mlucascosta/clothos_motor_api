...
import { IncraSigefRequerimentosResponseSchema, type IncraSigefRequerimentosItem } from '../dtos/IncraSigefRequerimentosDto.js';
...
export class IncraSigefRequerimentos implements IInfosimplesOperation<IncraSigefRequerimentosItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, IncraSigefRequerimentosItem>> {
