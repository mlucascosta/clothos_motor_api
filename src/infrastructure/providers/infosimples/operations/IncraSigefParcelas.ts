...
import { IncraSigefParcelasResponseSchema, type IncraSigefParcelasItem } from '../dtos/IncraSigefParcelasDto.js';
...
export class IncraSigefParcelas implements IInfosimplesOperation<IncraSigefParcelasItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, IncraSigefParcelasItem>> {
