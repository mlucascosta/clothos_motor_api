...
import { DiarioOficialSpValorVenalResponseSchema, type DiarioOficialSpValorVenalItem } from '../dtos/DiarioOficialSpValorVenalDto.js';

export class DiarioOficialSpValorVenal implements IInfosimplesOperation<DiarioOficialSpValorVenalItem> {
  readonly path = 'consultas/diario-oficial/sp/valor-venal';

  constructor(private readonly http: IHttpClient) {}

  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, DiarioOficialSpValorVenalItem>> {
