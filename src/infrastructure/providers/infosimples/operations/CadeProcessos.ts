...
import { CadeProcessosResponseSchema, type CadeProcessosItem } from '../dtos/CadeProcessosDto.js';
...
export class CadeProcessos implements IInfosimplesOperation<CadeProcessosItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, CadeProcessosItem>> {
    ...
    return parseOrSchemaError(CadeProcessosResponseSchema, result.value, 'infosimples');
  }
}
