...
import { CaixaRegularidadeResponseSchema, type CaixaRegularidadeItem } from '../dtos/CaixaRegularidadeDto.js';
...
export class CaixaRegularidade implements IInfosimplesOperation<CaixaRegularidadeItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, CaixaRegularidadeItem>> {
