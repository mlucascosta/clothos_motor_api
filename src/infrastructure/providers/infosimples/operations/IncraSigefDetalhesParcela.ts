...
import { IncraSigefDetalhesParcelaResponseSchema, type IncraSigefDetalhesParcelaItem } from '../dtos/IncraSigefDetalhesParcelaDto.js';

export class IncraSigefDetalhesParcela implements IInfosimplesOperation<IncraSigefDetalhesParcelaItem> {
  readonly path = 'consultas/incra/sigef/detalhes-parcela';

  constructor(private readonly http: IHttpClient) {}

  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, IncraSigefDetalhesParcelaItem>> {
