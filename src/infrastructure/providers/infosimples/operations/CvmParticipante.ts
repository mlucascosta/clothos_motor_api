...
import {
  type CvmParticipanteItem,
  CvmParticipanteResponseSchema,
} from '../dtos/CvmParticipanteDto.js';
...
export class CvmParticipante implements IInfosimplesOperation<CvmParticipanteItem> {
  ...
  async execute(
  ...
  ): Promise<Either<SourceError, CvmParticipanteItem>> {
    ...
    return parseInfosimplesResponse(CvmParticipanteResponseSchema, result.value);
  }
}
