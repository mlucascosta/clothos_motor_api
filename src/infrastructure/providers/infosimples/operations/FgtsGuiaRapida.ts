...
import { FgtsGuiaRapidaResponseSchema, type FgtsGuiaRapidaItem } from '../dtos/FgtsGuiaRapidaDto.js';
...
export class FgtsGuiaRapida implements IInfosimplesOperation<FgtsGuiaRapidaItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, FgtsGuiaRapidaItem>> {
    ...
    return parseOrSchemaError(FgtsGuiaRapidaResponseSchema, result.value, 'infosimples');
  }
}
