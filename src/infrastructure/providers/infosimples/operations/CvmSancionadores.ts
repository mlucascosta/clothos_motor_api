...
import { CvmSancionadoresResponseSchema, type CvmSancionadoresItem } from '../dtos/CvmSancionadoresDto.js';
...
export class CvmSancionadores implements IInfosimplesOperation<CvmSancionadoresItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, CvmSancionadoresItem>> {
    ...
    return parseOrSchemaError(CvmSancionadoresResponseSchema, result.value, 'infosimples');
  }
}
