...
import { SefazDfIptuResponseSchema, type SefazDfIptuItem } from '../dtos/SefazDfIptuDto.js';
...
export class SefazDfIptu implements IInfosimplesOperation<SefazDfIptuItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, SefazDfIptuItem>> {
    ...
    return parseOrSchemaError(SefazDfIptuResponseSchema, result.value, 'infosimples');
  }
}
