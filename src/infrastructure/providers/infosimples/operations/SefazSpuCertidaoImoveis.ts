...
import { SefazSpuCertidaoImoveisResponseSchema, type SefazSpuCertidaoImoveisItem } from '../dtos/SefazSpuCertidaoImoveisDto.js';
...
export class SefazSpuCertidaoImoveis implements IInfosimplesOperation<SefazSpuCertidaoImoveisItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, SefazSpuCertidaoImoveisItem>> {
