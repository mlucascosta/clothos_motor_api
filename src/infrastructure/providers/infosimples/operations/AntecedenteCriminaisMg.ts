...
import { AntecedenteCriminaisMgResponseSchema, type AntecedenteCriminaisMgItem } from '../dtos/AntecedenteCriminaisMgDto.js';
...
export class AntecedenteCriminaisMg implements IInfosimplesOperation<AntecedenteCriminaisMgItem> {
  ...
  async execute(params: Record<string, string | undefined>): Promise<Either<SourceError, AntecedenteCriminaisMgItem>> {
    ...
    return parseOrSchemaError(AntecedenteCriminaisMgResponseSchema, result.value, 'infosimples');
  }
}
