...
import { ListarCallbacksV2ResponseSchema, type ListarCallbacksV2Response } from '../../dtos/v2/CallbackV2Dto.js';
...
export class ListarCallbacksV2 implements IListarCallbacksV2 {
  ...
  async execute(input: { pagina?: number }): Promise<Either<SourceError, ListarCallbacksV2Response>> {
