...
import type { IIniciarBuscaProcessosOab, IniciarBuscaProcessosOabInput } from '../ports/IIniciarBuscaProcessosOab.js';
...
export class IniciarBuscaProcessosOab implements IIniciarBuscaProcessosOab {
  ...
  async execute(input: IniciarBuscaProcessosOabInput): Promise<Either<SourceError, IniciarBuscaResponse>> {
